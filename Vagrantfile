...
Vagrant.configure("2") do |config|
  ...
  # using a specific IP.
  config.vm.network "private_network", ip: "192.168.88.225"

  # Create a public network, which generally matched to bridged network.
  # Bridged networks make the machine appear as another physical device on
  # your network.
  # config.vm.network "public_network", ip: "192.168.88.225"
  ...
  config.vm.synced_folder "/home/darko/DEVTECH/DudaMobile/Dudamobile.WHMCS.Provisioning/adminlang/lang/overrides/", "/var/www/html/whmcs/admin/lang/overrides/", create: true , type: "nfs" 
